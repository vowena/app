      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        {!address ? (
          <EmptyState
            ...
            description="View and manage all subscriptions linked to your Stellar wallet."
          />
...
function SubscriptionCard({
  ...
  return (
    <button
      onClick={onClick}
      className="text-left rounded-xl border border-border bg-elevated hover:border-accent/40 transition-all duration-200 p-6 group flex flex-col"
    >
      ...
      <div className="mt-auto pt-4 border-t border-border-subtle flex items-center gap-2 text-xs text-muted">
        ...
        <span>
          {nextBillingIn > 0
            ? `Next ${nextBillingDate.toLocaleDateString(undefined, { month: "short", day: "numeric" })}`
            : "Due now"}
        </span>
